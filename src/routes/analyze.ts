      ...
      messages: [
       {
        ...
        [출력 JSON 형식]
        {
          ...
          "face": "해당 이미지에 대한 얼굴형과 구조에 대한 관상학적 해석 (장점 + 주의점 포함)",
          "forehead": "해당 이미지에 대한 이마에 대한 관상학적 해석 (장점 + 주의점 포함)",
          "eyes": "해당 이미지에 대한 눈에 대한 관상학적 해석 (장점 + 주의점 포함)",
          "nose": "해당 이미지에 대한 코에 대한 관상학적 해석 (장점 + 주의점 포함)",
          "mouth": "해당 이미지에 대한 입에 대한 관상학적 해석 (장점 + 주의점 포함)",
          "chin": "해당 이미지에 대한 턱과 하관에 대한 관상학적 해석 (장점 + 주의점 포함)",
